...
int write_octal(va_list param, formats options, char *base)
{
    ...
    return (write_octal_long(param, options, base));
}

static int write_octal_long(va_list param, formats options, char *base)
{
