...
static int write_hex_2_long(va_list, formats, char *);

int write_hex_2(va_list param, formats options, char *base)
{
    ...
    return (write_hex_2_long(param, options, base));
}

static int write_hex_2_long(va_list param, formats options, char *base)
{
